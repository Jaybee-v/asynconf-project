        ...
        <section className="px-8 py-4 mx-auto">
            {data.type.score > 6 && (
                <div className="w-full mx-auto">
                    <h2 className="py-2 -ms-4 font-semibold tracking-wide text-primary">
                        Les atouts de votre véhicule
                    </h2>
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        {data.mileage.score > 6 && data.bonus < -0.3 && (
                            <div>
                                ...
                                <p>
                                    Félcitations, non seulement vous effectuez
                                    des courts trajets annuels, mais vous ne
                                    roulez jamais à vide
                                </p>
                            </div>
                        )}
                    </div>
            ...
            {data.energy.score < 6 && (
                <div className="w-full mx-auto">
                    <h2 className="py-2 -ms-4 font-semibold tracking-wide text-red-500">
                        Envisagez de changer ces points
                    </h2>
                    <div className="grid grid-cols-4 gap-4">
                        {data.type.score < 6 && (
                            <div>
                        ...
                        {data.energy.score < 5 && (
                            <div>
                                ...
                                <p>
                                    ...
                                    vous devriez opter pour un véhicule
                        ...
                        {data.mileage.score < 6 && (
                            <div>
                                ...
                                <p>
                                    {" "}
                                    {data.mileage.min} - {data.mileage.max} 000
                                    km / an
                                </p>
                            </div>
                        )}
