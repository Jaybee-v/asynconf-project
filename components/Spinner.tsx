    ...
    return (
        <section className="w-full h-fit mx-auto flex flex-col items-center justify-center">
            ...
            <h2 className="text-lg text-primary ">
                Chargement <span className="animate-ping text-5xl ps-2">.</span>
                <span className="animate-ping delay-75 text-5xl">.</span>
                <span className="animate-ping delay-150 text-5xl">.</span>
            </h2>
        </section>
    )
}
